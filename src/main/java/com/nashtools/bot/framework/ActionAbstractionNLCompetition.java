...
public class ActionAbstractionNLCompetition extends ActionAbstraction {
	...
	public final static double[] initial_betsizes = new double[]{0.25, 0.5, 0,75, 1, 1.5, 2, 4, 8, 15, 25, 50};
	public final static double[] raise_betsizes =   new double[]{0.25, 0.5, 1, 2, 4, 8, 15, 25, 50};
	...
	public int get_actions(Game game, State state, Action[] actions) {
		  ...
		  int post_commitment = (int) (max_raise_size[0] * 0.75);
	    if(num_bets > 0){
