 ...
 * <p>
 * This implementation is a wrapper on {@link ArrayList}<{@link Card}> that
 * allows no duplicates. A CardSet's iterator will provide elements in FIFO
 * order -- the order in which the elements were added -- if the instance's
 * shuffle method has not been invoked.
 * <p>
 * It also provides a 52-card deck.
 * <p>
 * Methods not otherwise documented forward to {@link ArrayList}<{@link Card}>
 * or perform as specified by the {@link Set} interface.
 * 
 * @version 2006Dec04.0
...
public final class CardSet implements Set<Card> {
	 ...
	 * 
	 * @return a 52-card deck in order from clubs to spades and within each suit
	 *         from deuce to Ace.
	 */
	...
	/**
	 * Returns <code>true</code> if this CardSet did not already contain the
	 * specified Card.
	 * 
	 * @return <code>true</code> if this CardSet did not already contain the
	 *         specified Card.
	 */
	 ...
	 * 
	 * @return <code>true</code> if this CardSet changed as a result of the call;
	 *         <code>false</code> if all of the Cards in the specified Collection
	 *         were already present in this CardSet.
	 */
