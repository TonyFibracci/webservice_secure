...
public class Card {
	 ...
	 * @param suit
	 *          a {@link Suit}
	 * @see #getInstance(com.stevebrecher.poker.Card.Rank,
	 *      com.stevebrecher.poker.Card.Suit)
	 */
	 ...
	 * 
	 * @param rs
	 *          a {@link String} of length 2, where the first character is in
	 *          {@link Card.Rank#RANK_CHARS} and
	 *          the second is in {@link Card.Suit#SUIT_CHARS} (case insensitive).
	 * @throws IllegalArgumentException
	 *           on the first character in rs which is not found in the respective
	 *           string.
	...
	/**
	 * Returns a pre-existing instance of {@link Card} of the specified rank and
	 * suit.
	 * 
	 * @param rank
	 *          a {@link Rank}
	...
	/**
	 * Returns a {@link String} of length 2 denoting the rank and suit of this
	 * card.
	 * 
	 * @return a {@link String} of length 2 containing a character in
	 *         {@link Card.Rank#RANK_CHARS} denoting this
	 *         card&#39;s rank followed by a character in
	 *         {@link Card.Suit#SUIT_CHARS} denoting this
	 *         card&#39;s suit.
	 */
	@Override
	 ...
	 * 
	 * @return <code>true</code> if the parameter is a {@link Card} of the same
	 *         rank and suit
	...
	public static Rank rankFromInt(int r) {

		return Rank.values()[r];
	}

	public static Suit suitFromInt(int s) {
