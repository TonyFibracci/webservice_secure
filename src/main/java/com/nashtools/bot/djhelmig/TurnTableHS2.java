...
public class TurnTableHS2 {
	...
	private TurnHS2 tthread[] = new TurnHS2[2];
	...
	public int testLUT(int n) {
		...
		for (int i = 0; i < n; i++) {
			...
			float direct = TurnHS2.turnklaatuHS2(cards);
	...
	public void handDebug() {
		...
		int h[] = { 0 * 4 + 0, 1 * 4 + 0, 3 * 4 + 1, 4 * 4 + 1, 7 * 4 + 2, 7 * 4 + 4 };
		int h2[] = { 0 * 4 + 0, 1 * 4 + 1, 3 * 4 + 2, 4 * 4 + 2, 7 * 4 + 3, 7 * 4 + 4 };

		int h3[] = { 0 * 4 + 0, 1 * 4 + 1, 3 * 4 + 0, 4 * 4 + 2, 7 * 4 + 3, 7 * 4 + 4 };
		int h4[] = { 0 * 4 + 0, 1 * 4 + 1, 3 * 4 + 1, 4 * 4 + 2, 7 * 4 + 3, 7 * 4 + 4 };

		float f = TurnHS2.turnklaatuHS2(h);
		float f2 = TurnHS2.turnklaatuHS2(h2);
		float f3 = TurnHS2.turnklaatuHS2(h3);
		float f4 = TurnHS2.turnklaatuHS2(h4);
	...
	public static void main(String[] args) {
		...
		TurnTableHS2 t = new TurnTableHS2();
